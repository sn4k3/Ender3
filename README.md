...
2. Start and configure PrusaSlicer (Wizard)
	* Choose Prusa MK3 and Creality Ender3 printers
	* Choose the filaments you want to apper (This can be latter done under Filament dropdown and select "Add/Remove Materials")
3. Close PrusaSlicer
